...
export default function FootballPage() {
  const quickActions = [
    { icon: MapPin, label: "Book Turf", href: "/venues?sport=football", color: "green" },
    { icon: Users, label: "Find Players", href: "/players?sport=football", color: "blue" },
    { icon: Users, label: "Find Teams", href: "/teams?sport=football", color: "purple" },
    { icon: Trophy, label: "Tournaments", href: "/tournaments?sport=football", color: "orange" },
  ]
        ...
        <motion.div className="mb-12 text-center" {...fadeInUp}>
          <div className="relative mb-8">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h2 className="text-4xl font-bold mb-2">Football</h2>
              <div className="flex items-center space-x-4">
                <Badge className="bg-white/20 text-white border border-white/30">3,891 Active Players</Badge>
                <Badge className="bg-white/20 text-white border border-white/30">98 Venues</Badge>
                <Badge className="bg-white/20 text-white border border-white/30">18 Tournaments</Badge>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold">Popular Football Venues</h3>
              <Link href="/venues?sport=football">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/tournaments?sport=football">
                <Button variant="outline" size="sm" className="border-gray-600 text-gray-300 hover:bg-gray-800">
                  View All
                </Button>
              </Link>
